/**
 * SessionHeader — day label + elapsed timer + Complete Workout button.
 *
...
interface SessionHeaderProps {
  ...
  onComplete: () => void;
  /** Optional: open the session-level note sheet (Plan 09) */
  onOpenNote?: () => void;
...
export function SessionHeader({
  ...
  return (
    <View className="px-md pt-sm flex-row items-center justify-between" style={{ minHeight: 56 }}>
